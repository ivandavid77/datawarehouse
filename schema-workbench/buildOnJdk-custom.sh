#!/bin/bash
# $Id$
# Called recursively from '/opt/ant1.7/bin/ant release' to build the files which can only be
# built under a particular JDK version.
#
# Usage:
#   buildOnJdk.sh <jdk version> </opt/ant1.7/bin/ant args>
#
# For example:
...
# version. It will keep the existing JAVA_HOME, /opt/ant1.7/bin/ant will report that the JDK
...
# before invoking '/opt/ant1.7/bin/ant'.
#
